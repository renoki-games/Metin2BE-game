...
function say_normal(name) say(color256(0, 0, 255)..name..color256(196, 196, 196)) end
...
function say_cyan(name) say(color256(0, 206, 209)..name..color256(196, 196, 196)) end
function notice_all_blue(name) say(color256(0, 0, 255)..name..color256(196, 196, 196)) end
function notice_all_red(name) say(color256(255, 0, 0)..name..color256(196, 196, 196)) end
function notice_all_green(name) say(color256(0, 238, 0)..name..color256(196, 196, 196)) end
function notice_all_gold(name) say(color256(255, 215, 0)..name..color256(196, 196, 196)) end
function notice_all_black(name) say(color256(0, 0, 0)..name..color256(196, 196, 196)) end
function notice_all_white(name) say(color256(255, 255, 255)..name..color256(196, 196, 196)) end
function notice_all_yellow(name) say(color256(255, 255, 0)..name..color256(196, 196, 196)) end
function notice_all_cyan(name) say(color256(0, 206, 209)..name..color256(196, 196, 196)) end

dofile( get_locale_base_path() .. "/quest/LIB/horse_appearence.lua")
